...
def main():
    ...
    # ---- [2] live triple --------------------------------------------------
    check(2, 'pyproject version = "3.73.0"',
          'version = "3.73.0"' in _read("pyproject.toml"))
    check(2, "banner 'Polyhedron Suite  v373' (two spaces)",
          "Polyhedron Suite  v373" in _read("__init__.py"))
    check(2, 'uls_compat PLUGIN_VERSION = "v373"',
          'const PLUGIN_VERSION = "v373";' in _read("web", "js", "uls_compat.js"))
