...
def main():
    ...
    # ---- [2] live triple --------------------------------------------------
    check(2, 'pyproject version = "3.72.0"',
          'version = "3.72.0"' in _read("pyproject.toml"))
    check(2, "banner 'Polyhedron Suite  v372' (two spaces)",
          "Polyhedron Suite  v372" in _read("__init__.py"))
    check(2, 'uls_compat PLUGIN_VERSION = "v372"',
          'const PLUGIN_VERSION = "v372";' in _read("web", "js", "uls_compat.js"))
