...
def main():
    ...
    # ---- [2] live triple --------------------------------------------------
    check(2, 'pyproject version = "3.64.0"',
          'version = "3.64.0"' in _read("pyproject.toml"))
    check(2, "banner 'Polyhedron Suite  v364' (two spaces)",
          "Polyhedron Suite  v364" in _read("__init__.py"))
    check(2, 'uls_compat PLUGIN_VERSION = "v364"',
