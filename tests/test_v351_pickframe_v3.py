...
def main():
    ...
    # ---- [2] live triple --------------------------------------------------
    check(2, 'pyproject version = "3.74.0"',
          'version = "3.74.0"' in _read("pyproject.toml"))
    check(2, "banner 'Polyhedron Suite  v374' (two spaces)",
          "Polyhedron Suite  v374" in _read("__init__.py"))
    check(2, 'uls_compat PLUGIN_VERSION = "v374"',
          'const PLUGIN_VERSION = "v374";' in _read("web", "js", "uls_compat.js"))
