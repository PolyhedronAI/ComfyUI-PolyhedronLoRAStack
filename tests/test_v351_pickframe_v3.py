...
def main():
    ...
    # ---- [2] live triple --------------------------------------------------
    check(2, 'pyproject version = "3.75.0"',
          'version = "3.75.0"' in _read("pyproject.toml"))
    check(2, "banner 'Polyhedron Suite  v375' (two spaces)",
          "Polyhedron Suite  v375" in _read("__init__.py"))
    check(2, 'uls_compat PLUGIN_VERSION = "v375"',
          'const PLUGIN_VERSION = "v375";' in _read("web", "js", "uls_compat.js"))
