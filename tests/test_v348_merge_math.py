...
print("[8] version triple v372")
def _read(*p):
    with open(os.path.join(HERE, "..", *p), encoding="utf-8") as f:
        return f.read()
check("__init__ banner v372", "Polyhedron Suite  v372" in _read("__init__.py"))
check("uls_compat PLUGIN_VERSION v372", 'PLUGIN_VERSION = "v372"' in _read("web", "js", "uls_compat.js"))
