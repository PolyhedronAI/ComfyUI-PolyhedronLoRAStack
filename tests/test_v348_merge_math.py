...
print("[8] version triple v364")
def _read(*p):
    with open(os.path.join(HERE, "..", *p), encoding="utf-8") as f:
        return f.read()
check("__init__ banner v364", "Polyhedron Suite  v364" in _read("__init__.py"))
check("uls_compat PLUGIN_VERSION v364", 'PLUGIN_VERSION = "v364"' in _read("web", "js", "uls_compat.js"))
