...
print("[8] version triple v375")
def _read(*p):
    with open(os.path.join(HERE, "..", *p), encoding="utf-8") as f:
        return f.read()
check("__init__ banner v375", "Polyhedron Suite  v375" in _read("__init__.py"))
check("uls_compat PLUGIN_VERSION v375", 'PLUGIN_VERSION = "v375"' in _read("web", "js", "uls_compat.js"))
